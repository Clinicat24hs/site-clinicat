      ...
      <section className="section">
        <div className="container">
          <div className="svc-list">
            <a href="/servicos/consultas" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">1</span><h3>Consultas</h3><p>Avaliação completa do seu pet com especialistas. Diagnóstico preciso e plano de tratamento personalizado. Seu pet merece atenção total.</p></article></a>
            <a href="/servicos/cirurgias" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">2</span><h3>Cirurgias</h3><p>Procedimentos de alta complexidade realizados por cirurgiões experientes. De castrações a cirurgias ortopédicas avançadas. Segurança e excelência técnica garantidas.</p></article></a>
            <a href="/servicos/internacao" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">3</span><h3>Internação</h3><p>Acompanhamento 24h com equipe especializada. Seu pet recebe monitoramento contínuo, medicação e cuidados intensivos. Você pode visitar a qualquer hora.</p></article></a>
            <a href="/servicos/hotel-creche" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">4</span><h3>Hotel / Creche</h3><p>Hospedagem segura e confortável. Ambiente climatizado, alimentação adequada e atividades recreativas. Seu pet fica feliz enquanto você trabalha.</p></article></a>
            <a href="/servicos/banho-e-tosa" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">5</span><h3>Banho e Tosa</h3><p>Higiene e estética com profissionais experientes. Técnicas gentis que respeitam o bem-estar do seu pet. Seu pet sai bonito e feliz.</p></article></a>
            <a href="/servicos/exames" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">6</span><h3>Exames</h3><p>Diagnóstico rápido e preciso com laboratório próprio. Exames de sangue, imagem e endoscopia disponíveis. Resultados em até 1 dia útil.</p></article></a>
            <a href="/servicos/farmacia" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">7</span><h3>Farmácia</h3><p>Medicamentos veterinários com orientação especializada. Prescrição → compra → entrega, tudo em um só lugar. Conveniência e segurança garantidas.</p></article></a>
            ...
            <a href="/servicos/castracao" style={{ textDecoration: "none", color: "inherit" }}><article className="svc-item"><span className="num">12</span><h3>Castração</h3><p>Procedimento seguro com anestesia inalatória, equipe anestesista e cirurgião, exames pré-anestésicos e acompanhamento no pós-operatório.</p></article></a>
          </div>
        </div>
      </section>

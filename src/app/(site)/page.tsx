...
export const metadata: Metadata = {
  ...
  description:
    "Hospital veterinário 24h em Perdizes, SP. Emergência, internação, 15+ especialidades, exames, cirurgia, banho e tosa, creche e hotel. Atendimento humanizado para cães e gatos.",
};
    ...
    <>
      ...
      <section id="servicos" className="services">
        <div className="container">
          ...
          <div className="cards">
            <article className="card"><div className="ic"><svg className="ico" width="1em" height="1em" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.29 1.49 4.04 3 5.5l7 7Z" /></svg></div><h3>Atendimento 24h</h3><p>Clínica, emergência e internação com equipe sempre presente.</p><ul><li>Clínico</li><li>Emergência</li><li>Internação</li></ul></article>

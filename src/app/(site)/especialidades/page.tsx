      ...
      <section className="section">
        <div className="container">
          ...
          <div className="spec-grid">
            <a href="/especialidades/cardiologia" style={{ textDecoration: "none", color: "inherit" }}>
            ...
            <a href="/especialidades/ortopedia" style={{ textDecoration: "none", color: "inherit" }}>
              <article className="spec-card">
            ...
            <a href="/especialidades/dermatologia" style={{ textDecoration: "none", color: "inherit" }}>
              <article className="spec-card">
            ...
            <a href="/especialidades/oftalmologia" style={{ textDecoration: "none", color: "inherit" }}>
              <article className="spec-card">
            ...
            <a href="/especialidades/oncologia" style={{ textDecoration: "none", color: "inherit" }}>
              <article className="spec-card">
            ...
            <a href="/especialidades/nefrologia" style={{ textDecoration: "none", color: "inherit" }}>
              <article className="spec-card">
          ...
          <ul className="chip-list">
            <li className="chip"><a href="/especialidades/clinica-geral" style={{ textDecoration: "none", color: "inherit" }}>Clínica Geral</a></li>
            <li className="chip"><a href="/especialidades/anestesiologia" style={{ textDecoration: "none", color: "inherit" }}>Anestesiologia</a></li>
            <li className="chip"><a href="/especialidades/neurologia" style={{ textDecoration: "none", color: "inherit" }}>Neurologia</a></li>
            <li className="chip"><a href="/especialidades/endocrinologia" style={{ textDecoration: "none", color: "inherit" }}>Endocrinologia</a></li>
            <li className="chip"><a href="/especialidades/hematologia" style={{ textDecoration: "none", color: "inherit" }}>Hematologia</a></li>
            <li className="chip"><a href="/especialidades/gastroenterologia" style={{ textDecoration: "none", color: "inherit" }}>Gastroenterologia</a></li>
            <li className="chip"><a href="/especialidades/pneumologia" style={{ textDecoration: "none", color: "inherit" }}>Pneumologia</a></li>
            <li className="chip"><a href="/especialidades/nutrologia" style={{ textDecoration: "none", color: "inherit" }}>Nutrologia</a></li>
            <li className="chip"><a href="/especialidades/odontologia" style={{ textDecoration: "none", color: "inherit" }}>Odontologia</a></li>
            <li className="chip"><a href="/especialidades/fisioterapia" style={{ textDecoration: "none", color: "inherit" }}>Fisioterapia</a></li>
            <li className="chip"><a href="/especialidades/acupuntura" style={{ textDecoration: "none", color: "inherit" }}>Acupuntura</a></li>
            <li className="chip"><a href="/especialidades/medicina-felina" style={{ textDecoration: "none", color: "inherit" }}>Medicina Felina</a></li>
            <li className="chip"><a href="/especialidades/diagnostico-por-imagem" style={{ textDecoration: "none", color: "inherit" }}>Diagnóstico por Imagem</a></li>
          </ul>
        </div>
      </section>
